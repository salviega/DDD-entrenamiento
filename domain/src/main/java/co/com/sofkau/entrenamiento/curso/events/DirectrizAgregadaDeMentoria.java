...
public class DirectrizAgregadaDeMentoria extends DomainEvent {
    private  final MentoriaId mentoriaId;
    private  final Directiz directiz;

    public DirectrizAgregadaDeMentoria(MentoriaId mentoriaId, Directiz directiz) {
